...
commonObject.prototype = {
    ...
    renderPromote:function(){
        ...
        if(query.type == 1){
            ...
            var wx_text = '微信';
            var wx_logo = '<img src="/Public/Home/images/wx.gif">';
            var wx_logo_src = '/Public/Home/images/wx.gif';
            var wx_url = 'weixin://';
        }else if(query.type == 0){
            var wxid = query.promote;
            var imageUrl = query.imageUrl;
            var wx_logo = '<img src="/Public/Home/images/qq.png">';
            var wx_logo_src = '/Public/Home/images/qq.png';
            var wx_text = 'QQ';
            ...
            if(event.data && event.data.promote_type){
                ...
                if(sjWeiXin){
                    if(event.data.promote_type == 'QQ'){
                        sjWeiXin.getElementsByTagName('img')[0].src = "/Public/Home/images/qq.png";
                    }else if(event.data.promote_type == '微信'){
                        sjWeiXin.getElementsByTagName('img')[0].src = "/Public/Home/images/wx.gif";
                    }
                };
                ...
                if(landingPageIcon[0]){
                    var wx_logo = "";
                    if(event.data.promote_type == 'QQ'){
                        wx_logo = "/Public/Home/images/qq.png";
                    }else if(event.data.promote_type == '微信'){
                        wx_logo = "/Public/Home/images/wx.gif";
                    }
    ...
    createBanner:function(){
        if(!!tel){
            ...
            div.style.backgroundImage = 'url(/Public/Home/images/tel-bg.png)';
